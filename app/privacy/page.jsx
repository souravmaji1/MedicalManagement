...
import { 
  ...
  Database, Server, Key, UserCheck, AlertOctagon, Info,
      ...
      <div className="p-6 border-b border-slate-800/50 flex-shrink-0">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-slate-300 font-semibold">System Secure</span>
          </div>
        ...
        <div className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/30 rounded-xl p-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs text-slate-300 font-semibold">Privacy Compliant</span>
          </div>
          <p className="text-xs text-slate-400">All data encrypted & secure</p>
        </div>
      </div>
