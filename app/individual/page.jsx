            ...
            <main className="p-6 lg:p-8">
              <div className="space-y-8 animate-in fade-in duration-500">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <div className="group relative bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 hover:border-emerald-500/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-emerald-500/20 overflow-hidden">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-green-400 to-emerald-500 opacity-10 rounded-full blur-3xl group-hover:opacity-Continue13:2620 transition-all duration-300"></div>
<div className="relative z-10">
<div className="flex items-start justify-between mb-4">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  {canEditIndividuals && (
                                    <button 
                                      onClick={(e) => {
                                        e.stopPropagation();
                                        router.push(`/individual/${individual.id}?edit=true`);
                                      }}
                                  ...
                                  {canDeleteIndividuals && (
                                    <button 
                                      onClick={(e) => {
                                        e.stopPropagation();
                                        handleDeleteIndividual(individual.id);
                                      }}
          ...
          <form onSubmit={handleAddIndividual} className="p-6 space-y-6">
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-700">
              <button
                type="button"
                onClick={() => setShowAddModal(false)}
                className="px-6 py-3 bg-slate-800 hover:bg-slate-700 text-white rounded-xl font-semibolContinue13:28d transition-all duration-300"
>
Cancel
</button>
<button
